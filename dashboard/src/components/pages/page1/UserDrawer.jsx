...
const UserDrawer = ({ selectedUser, showUserDrawer, handleCloseDrawer,getUserOrders, orders }) => {
  ...
  const userOrders = getUserOrders(orders, selectedUser.user_id);
                        ...
                        <div className="p-4">
                          <div className="flex justify-between mb-4">
                            ...
                            <div className="text-right">
                              ...
                              <p>
                                <span
                                  className={`inline-block px-2 py-1 text-xs rounded-full text-gray-800 dark:text-white ${getStatusColor(
                                    order.status
                                  )}`}
                                >
                                  {order.status || 'N/A'}
